...
ref class VertexShaderPipelineStage;
    ...
    public: 
        ...
        /// <param name="clearFlags">Identify the type of data to clear (see <see cref="ClearFlag"/>)<seealso cref="ClearFlag"/>.</param>
        ...
        void ClearDepthStencilView(DepthStencilView^ depthStencilView, ClearFlag clearFlags, Single depth, Byte stencil);
        ...
        /// <param name="unorderedAccessView">Pointer to the Unordered Access View.</param>
        /// <param name="values">A 4-component array that contains the values.</param>
        void ClearUnorderedAccessViewUint(UnorderedAccessView^ unorderedAccessView, array<UInt32>^ values);
        ...
        void DrawIndexedInstancedIndirect(D3DBuffer^ BufferForArgs, UInt32 AlignedByteOffsetForArgs);
        ...
        /// <param name="AlignedByteOffsetForArgs">TBD</param>
        void DrawInstancedIndirect(D3DBuffer^ BufferForArgs, UInt32 AlignedByteOffsetForArgs);
        ...
        void FinishCommandList(Boolean restoreDeferredContextState, [System::Runtime::InteropServices::Out] CommandList^ %outCommandList);
        ...
        void GetData(Asynchronous^ asyncData, IntPtr data, UInt32 dataSize, AsyncGetDataFlag flags);
        ...
        void GetPredication([System::Runtime::InteropServices::Out] D3DPredicate^ %outPredicate, [System::Runtime::InteropServices::Out] Boolean %outPredicateValue);
        ...
        Single GetResourceMinLOD(D3DResource^ Resource);
        ...
        /// <param name="mappedResource">The mapped subresource (see <see cref="MappedSubresource"/>)<seealso cref="MappedSubresource"/>.</param>
        void Map(D3DResource^ resource, UInt32 subresource, D3D11::Map mapType, MapFlag mapFlags, MappedSubresource mappedResource);
        ...
        /// </summary>
        /// <param name="D3DPredicate">A predicate (see <see cref="D3DPredicate"/>)<seealso cref="D3DPredicate"/>. A NULL value indicates "no" predication; in this case, the value of PredicateValue is irrelevent but will be preserved for DeviceContext.GetPredication.</param>
        ...
        void SetPredication(D3DPredicate^ D3DPredicate, Boolean PredicateValue);
        ...
        void SetResourceMinLOD(D3DResource^ Resource, Single MinLOD);
    ...
    internal:
        ...
        DeviceContext(ID3D11DeviceContext* pNativeID3D11DeviceContext)
        {
            Attach(pNativeID3D11DeviceContext);
        }

...
ClassLinkage^ ClassInstance::GetClassLinkage()
{
    ID3D11ClassLinkage* tempoutLinkage = NULL;
    GetInterface<ID3D11ClassInstance>()->GetClassLinkage(&tempoutLinkage);
...
ClassInstanceDescription ClassInstance::Description::get()
{
    ...
    GetInterface<ID3D11ClassInstance>()->GetDesc((D3D11_CLASS_INSTANCE_DESC*)ptr);
...
String^ ClassInstance::InstanceName::get()
{
    ...
    try
    {
        GetInterface<ID3D11ClassInstance>()->GetInstanceName(tempInstanceName, &len);
...
String^ ClassInstance::TypeName::get()
{
    ...
    try
    {
        GetInterface<ID3D11ClassInstance>()->GetTypeName(tempTypeName, &len);

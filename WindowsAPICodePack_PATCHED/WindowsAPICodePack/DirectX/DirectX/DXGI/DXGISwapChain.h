...
ref class Output;
    ...
    public: 
        ...
        /// </summary>
        /// <param name="target">returns tshe output target (see <see cref="Output"/>)<seealso cref="Output"/> when the mode is full screen; otherwise null will be returned.</param>
        ...
        bool GetFullScreenState([System::Runtime::InteropServices::Out] Output^ %target);
        ...
        bool TryPresent(UInt32 syncInterval, PresentFlag flags, [System::Runtime::InteropServices::Out] ErrorCode % error);
        ...
        void ResizeBuffers(UInt32 bufferCount, UInt32 width, UInt32 height, Format newFormat, SwapChainFlag flags);
        ...
        bool TryResizeBuffers(UInt32 bufferCount, UInt32 width, UInt32 height, Format newFormat, SwapChainFlag flags, [System::Runtime::InteropServices::Out] ErrorCode % errorCode);

...
/// </summary>
public enum class DecodeMetadataCacheOptions
{
    /// <summary>
...
/// <summary>
/// Specifies access to a WICBitmap.
/// </summary>
[Flags]
public enum class BitmapLockFlags
{
    /// <summary>
    /// A read access lock.
    /// </summary>
...
/// <summary>
/// Specifies the desired cache usage for a WICBitmap.
/// </summary>

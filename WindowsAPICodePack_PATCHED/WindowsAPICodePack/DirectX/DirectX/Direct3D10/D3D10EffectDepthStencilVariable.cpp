...
DepthStencilDescription EffectDepthStencilVariable::GetBackingStore(UInt32 index)
{
    ...
    CommonUtils::VerifyResult(GetInterface<ID3D10EffectDepthStencilVariable>()->GetBackingStore(
        index, &desc));
...
DepthStencilState^  EffectDepthStencilVariable::GetDepthStencilState(UInt32 index)
{
    ...
    CommonUtils::VerifyResult(GetInterface<ID3D10EffectDepthStencilVariable>()->GetDepthStencilState(static_cast<UINT>(index), &tempoutDepthStencilState));

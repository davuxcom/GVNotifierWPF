...
GeometryShader^ EffectShaderVariable::GetGeometryShader(UInt32 shaderIndex)
{
    ...
    CommonUtils::VerifyResult(GetInterface<ID3D10EffectShaderVariable>()->GetGeometryShader(static_cast<UINT>(shaderIndex), &tempoutGS));
...
SignatureParameterDescription EffectShaderVariable::GetInputSignatureElementDescription(UInt32 shaderIndex, UInt32 elementIndex)
{
    ...
    CommonUtils::VerifyResult(GetInterface<ID3D10EffectShaderVariable>()->GetInputSignatureElementDesc(
...
SignatureParameterDescription EffectShaderVariable::GetOutputSignatureElementDescription(UInt32 shaderIndex, UInt32 elementIndex)
{
    ...
    CommonUtils::VerifyResult(GetInterface<ID3D10EffectShaderVariable>()->GetOutputSignatureElementDesc(
        shaderIndex, elementIndex, &desc));
...
PixelShader^ EffectShaderVariable::GetPixelShader(UInt32 shaderIndex)
{
    ...
    CommonUtils::VerifyResult(GetInterface<ID3D10EffectShaderVariable>()->GetPixelShader(static_cast<UINT>(shaderIndex), &tempoutPS));
...
EffectShaderDescription EffectShaderVariable::GetShaderDescription(UInt32 shaderIndex)
{
    ...
    CommonUtils::VerifyResult(GetInterface<ID3D10EffectShaderVariable>()->GetShaderDesc(shaderIndex, &desc));
...
VertexShader^ EffectShaderVariable::GetVertexShader(UInt32 shaderIndex)
{
    ...
    CommonUtils::VerifyResult(GetInterface<ID3D10EffectShaderVariable>()->GetVertexShader(static_cast<UINT>(shaderIndex), &tempoutVS));

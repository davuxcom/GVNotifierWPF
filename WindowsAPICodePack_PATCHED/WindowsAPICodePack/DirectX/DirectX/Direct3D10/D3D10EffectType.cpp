...
EffectTypeDescription EffectType::Description::get()
{
    ...
    CommonUtils::VerifyResult(GetInterface<ID3D10EffectType>()->GetDesc(&desc));
...
EffectType^ EffectType::GetMemberTypeByName(String^ name)
{
    ...
    try
    {
        ID3D10EffectType * returnValue = GetInterface<ID3D10EffectType>()->GetMemberTypeByName(static_cast<char*>(ptr.ToPointer()));
...
EffectType^ EffectType::GetMemberTypeBySemantic(String^ semantic)
{
    ...
    try
    {
        ID3D10EffectType * returnValue = GetInterface<ID3D10EffectType>()->GetMemberTypeBySemantic(static_cast<char*>(ptr.ToPointer()));

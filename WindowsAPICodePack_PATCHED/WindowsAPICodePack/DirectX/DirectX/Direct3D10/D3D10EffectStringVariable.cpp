...
String^ EffectStringVariable::StringValue::get()
{
    ...
    CommonUtils::VerifyResult(GetInterface<ID3D10EffectStringVariable>()->GetString(&tempoutString));
...
array<String^>^ EffectStringVariable::GetStringArray(UInt32 offset, UInt32 count)
{
    ...
    CommonUtils::VerifyResult(GetInterface<ID3D10EffectStringVariable>()->GetStringArray(&strVector[0], offset, count));

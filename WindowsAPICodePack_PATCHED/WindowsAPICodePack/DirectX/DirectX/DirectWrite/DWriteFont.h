...
namespace  Microsoft { namespace WindowsAPICodePack { namespace DirectX { namespace DirectWrite {
    ...
    /// </summary>
    property DWrite::FontFamily^ FontFamily    
    {
        DWrite::FontFamily^ get();
    }
    ...
    /// Determines whether the font supports the specified character.
    /// </summary>
    /// <param name="unicodeChar">That Unicode character.</param>
    /// <returns>
    /// True if the font supports the specified character or False if not.
    /// </returns>
    Boolean HasCharacter(System::Char unicodeChar);
    ...
    private:
        ...
        DWrite::FontFamily^ m_fontFamily;

...
namespace  Microsoft { namespace WindowsAPICodePack { namespace DirectX { namespace DirectWrite {
    ...
    public: 
        ...
        /// <remarks>To obtain a handle to a monitor use DXGI Output.Description property or
    ...
    internal:
        DWriteFactory() : m_fontCollection(0)
        { }
    
        DWriteFactory(IDWriteFactory* pNativeIDWriteFactory) : 
            DirectUnknown(pNativeIDWriteFactory), m_fontCollection(0)
        { }

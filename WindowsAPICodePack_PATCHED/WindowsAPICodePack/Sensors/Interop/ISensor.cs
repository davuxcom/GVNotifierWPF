...
namespace Microsoft.WindowsAPICodePack.Sensors
{
    ...
    internal interface ISensor
    {
        ...
        [PreserveSig]
        HRESULT GetID( out SENSOR_ID id );
        ...
        [PreserveSig]
        HRESULT GetCategory( out SENSOR_CATEGORY_ID sensorCategory );
        ...
        [PreserveSig]
        HRESULT GetType( out SENSOR_TYPE_ID sensorType );
        ...
        void GetEventInterest(
            out IntPtr pValues, [Out] out ULONG count );
        ...
        [PreserveSig]
        HRESULT SetEventInterest( [In, MarshalAs( UnmanagedType.LPArray, SizeParamIndex = 1 )] Guid[ ] pValues, [In] ULONG count );
